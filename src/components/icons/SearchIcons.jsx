export default function SearchIcons({ size = 24, color = "white", onClick, className }) {
  return (
    <svg className={className} onClick={onClick} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size}>
      <path
        fill={color}
